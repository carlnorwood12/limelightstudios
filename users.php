...
<head>
    ...
    <link rel="stylesheet" href="./dist/css/tabler.min.css?1692870487"/>
    <link rel="stylesheet" href="./dist/css/tabler-flags.min.css?1692870487"/>
    <link rel="stylesheet" href="./dist/css/tabler-payments.min.css?1692870487"/>
    <link rel="stylesheet" href="./dist/css/tabler-vendors.min.css?1692870487"/>
    <link rel="stylesheet" href="./dist/css/demo.min.css?1692870487"/>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['update'])) {
        ...
        $update = "UPDATE users SET username='$user', password='$pass', dob='$dob', account='$account', name='$name', age='$age' WHERE id='$hidden'";
        mysqli_query($dbhandle, $update) or die('Cannot update database!');
    }
    if (isset($_POST['add'])) {
        $account = $_SESSION['user_status'] ?? '';
        $insert = "INSERT INTO users (username, password, dob, account, name, age) VALUES ('$user', '$pass', '$dob', '$account', '$name', '$age')";
            ...
            <div class="collapse navbar-collapse" id="sidebar-menu">
                <ul class="navbar-nav pt-lg-3">
                  ...
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/lifebuoy -->
                    <img src="dashboard.svg" class="icon" width="20px" />
                  </span>
                    ...
                    <li class="nav-item">
                        ...
                        <img src="users.svg" class="icon" width="20px" />
                  </span>
                            <span class="nav-link-title">
                    Users
                  </span>
                  ...
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <img src="movies.svg" class="icon" width="20px" />
                  </span>
                            <span class="nav-link-title">
                    Movies
                  </span>
                  ...
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <img src="projector.svg" class="icon" width="20px" />
                  </span>
                            <span class="nav-link-title">
                    Screenings
                  </span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <img src="tickets.svg" class="icon" width="20px" />
                  </span>
                            <span class="nav-link-title">
                    Bookings
                  </span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <img src="rss.svg" class="icon" width="20px" />
                  </span>
                            <span class="nav-link-title">
                    Newsletters
                  </span>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="./" >
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                    <img src="reviews.svg" class="icon" width="20px" />
                  </span>
                            <span class="nav-link-title">
                    Reviews
                  </span>
