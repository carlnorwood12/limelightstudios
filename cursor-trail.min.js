/*! © JSOcean Cursor Trail Effects Bundle v1.0.1 */ !(function (t) {
  ...
  (e.m = t),
    ...
    (e.t = function (t, r) {
      ...
      if ((e.r(a), Object.defineProperty(a, "default", { enumerable: !0, value: t }), 2 & r && "string" != typeof t))
        for (var n in t)
          e.d(
            a,
            n,
  ...
  function (t, r, e) {
    var a = (function (t) {
      ...
      function M(t) {
        if (t) {
          ...
          if (!isNaN(t.length)) {
            var a = -1,
              f = function r() {
                for (; ++a < t.length; ) if (e.call(t, a)) return (r.value = t[a]), (r.done = !1), r;
      ...
      return (
        (h.prototype = u.constructor = w),
        (w.constructor = h),
        (h.displayName = c(w, o, "GeneratorFunction")),
        ...
        (y.prototype = {
          constructor: y,
          reset: function (t) {
            if (((this.prev = 0), (this.next = 0), (this.sent = this._sent = void 0), (this.done = !1), (this.delegate = null), (this.method = "next"), (this.arg = void 0), this.tryEntries.forEach(x), !t)) for (var r in this) "t" === r.charAt(0) && e.call(this, r) && !isNaN(+r.slice(1)) && (this[r] = void 0);
          },
          stop: function () {
            this.done = !0;
          ...
          delegateYield: function (t, r, e) {
            return (this.delegate = { iterator: M(t), resultName: r, nextLoc: e }), "next" === this.method && (this.arg = void 0), l;
          },
        }),
        t
      );
  ...
  function (t, r, e) {
    ...
    var a = e(1),
      ...
      h = {
        ...
        star30: function (t, r) {
          return '\n            <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(t, '" viewBox="0 0 336 336">\n              <path fill="')
            .concat(r, '" d="M168 218.4C128.4 218.4 88.8 241.2 49.2 286.8 94.8 247.2 117.6 207.6 117.6 168 117.6 128.4 94.8 88.8 49.2 49.2 88.8 94.8 128.4 117.6 168 117.6 207.6 117.6 247.2 94.8 286.8 49.2 241.2 88.8 218.4 128.4 218.4 168 218.4 207.6 241.2 247.2 286.8 286.8 247.2 241.2 207.6 218.4 168 218.4Z" transform="rotate(45 168 168)"/>\n            </svg>\n        ');
        },
        star35: function (t, r) {
          return '\n            <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(t, '" viewBox="0 0 336 336">\n              <path fill="')
            .concat(r, '" d="M168 226.8C128.4 226.8 88.8 246.8 49.2 286.8 89.2 247.2 109.2 207.6 109.2 168 109.2 128.4 89.2 88.8 49.2 49.2 88.8 89.2 128.4 109.2 168 109.2 207.6 109.2 247.2 89.2 286.8 49.2 246.8 88.8 226.8 128.4 226.8 168 226.8 207.6 246.8 247.2 286.8 286.8 247.2 246.8 207.6 226.8 168 226.8Z" transform="rotate(45 168 168)"/>\n            </svg>\n        ');
        },
        star40: function (t, r) {
          return '\n            <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(t, '" viewBox="0 0 336 336">\n              <path fill="')
            .concat(r, '" d="M168 235.2C128.4 235.2 88.8 252.4 49.2 286.8 83.6 247.2 100.8 207.6 100.8 168 100.8 128.4 83.6 88.8 49.2 49.2 88.8 83.6 128.4 100.8 168 100.8 207.6 100.8 247.2 83.6 286.8 49.2 252.4 88.8 235.2 128.4 235.2 168 235.2 207.6 252.4 247.2 286.8 286.8 247.2 252.4 207.6 235.2 168 235.2Z" transform="rotate(45 168 168)"/>\n            </svg>\n        ');
        },
        star45: function (t, r) {
          return '\n            <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(t, '" viewBox="0 0 336 336">\n              <path fill="')
            .concat(r, '" d="M168 243.6C128.4 243.6 88.8 258 49.2 286.8 78 247.2 92.4 207.6 92.4 168 92.4 128.4 78 88.8 49.2 49.2 88.8 78 128.4 92.4 168 92.4 207.6 92.4 247.2 78 286.8 49.2 258 88.8 243.6 128.4 243.6 168 243.6 207.6 258 247.2 286.8 286.8 247.2 258 207.6 243.6 168 243.6Z" transform="rotate(45 168 168)"/>\n            </svg>\n        ');
        },
        star55: function (t, r) {
          return '\n            <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(t, '" viewBox="0 0 336 336">\n              <path fill="')
            .concat(r, '" d="M168 260.4C128.4 260.4 88.8 269.2 49.2 286.8 66.8 247.2 75.6 207.6 75.6 168 75.6 128.4 66.8 88.8 49.2 49.2 88.8 66.8 128.4 75.6 168 75.6 207.6 75.6 247.2 66.8 286.8 49.2 269.2 88.8 260.4 128.4 260.4 168 260.4 207.6 269.2 247.2 286.8 286.8 247.2 269.2 207.6 260.4 168 260.4Z" transform="rotate(45 168 168)"/>\n            </svg>\n        ');
        },
        star60: function (t, r) {
          return '\n            <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(t, '" viewBox="0 0 239 240">\n              <path fill="')
            .concat(r, '" d="M119.5 191.7C91.3 191.7 63.2 196 35 204.5 43.5 176.3 47.8 148.2 47.8 120 47.8 91.8 43.5 63.7 35 35.5 63.2 44 91.3 48.3 119.5 48.3 147.7 48.3 175.8 44 204 35.5 195.5 63.7 191.2 91.8 191.2 120 191.2 148.2 195.5 176.3 204 204.5 175.8 196 147.7 191.7 119.5 191.7Z" transform="rotate(45 119.501 120)"/>\n            </svg>\n        ');
        },
        star80: function (t, r) {
          return '\n            <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(t, '" viewBox="0 0 268 268">\n              <path fill="')
            .concat(r, '" d="M134.3 241C102.7 241 71.2 236.9 39.7 228.6 31.4 197.1 27.3 165.5 27.3 134 27.3 102.5 31.4 70.9 39.7 39.4 71.2 31.1 102.7 27 134.3 27 165.8 27 197.3 31.1 228.8 39.4 237.1 70.9 241.3 102.5 241.3 134 241.3 165.5 237.1 197.1 228.8 228.6 197.3 236.9 165.8 241 134.3 241Z" transform="rotate(45 134.25 134)"/>\n            </svg>\n        ');
        },
      },
      w = {
      ...
      C = {
        ...
        starfish: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(r, '" viewBox="0 0 162 155"><path d="M80.6 127.7C55.8 127.7 41.2 161.3 31 153.8 20.8 146.4 48.1 122.1 40.5 98.5 32.8 74.9-3.4 71 0.4 59.3 4.2 47.7 35.8 65.9 55.8 51.3 75.9 36.7 68.2 0.9 80.6 0.9 93 0.9 85.3 36.7 105.4 51.3 125.4 65.9 156.9 47.4 160.8 59.3 164.7 71.3 128.4 74.9 120.7 98.5 113 122.1 140 146.7 130.2 153.8 120.3 161 105.4 127.7 80.6 127.7Z" fill="')
            .concat(e, '" /></svg>\n        ');
        },
        halfRoundFlower6: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(r, '" viewBox="0 0 192 169">\n          <path fill="')
            .concat(e, '" d="M96 132.7C70.9 160.2 54.9 171.9 48 167.9 41.1 163.9 43.2 144.2 54.4 108.7 18.1 100.7 0 92.7 0 84.7 0 76.7 18.1 68.7 54.4 60.7 43.2 25.2 41.1 5.4 48 1.4 54.9-2.6 70.9 9.2 96 36.6 121.1 9.2 137.1-2.6 144 1.4 150.9 5.4 148.8 25.2 137.6 60.7 173.9 68.7 192 76.7 192 84.7 192 92.7 173.9 100.7 137.6 108.7 148.8 144.2 150.9 163.9 144 167.9 137.1 171.9 121.1 160.2 96 132.7Z"/>\n        </svg>\n        ');
        },
      },
      u = {
        ...
        spiral4: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            ...
            .concat(
              r,
              '" viewBox="0 0 110 80"><g transform="translate(0 3)" fill="none"><polyline points="55.8 28.9 60.4 28.9 61.2 29.8 61.8 30.9 62.1 32.2 62.2 33.6 62 35.1 61.4 36.7 60.5 38.2 59.3 39.6 57.7 40.9 55.8 41.8 53.6 42.5 51.3 42.8 48.8 42.6 46.2 42.1 43.7 41 41.3 39.4 39.1 37.4 37.2 35 35.6 32.1 34.6 28.9 34 25.5 34 21.9 34.7 18.2 35.9 14.5 37.8 11 40.4 7.8 43.5 4.9 47.2 2.5 51.3 0.6 55.8 -0.5 60.5 -1 65.4 -0.7 70.3 0.5 75.1 2.4 79.6 5.2 83.7 8.7 87.3 12.9 90.2 17.8 92.4 23.2 93.6 28.9 94 35 93.4 41.1 91.7 47.2 89.1 53.1 85.5 58.6 81 63.5 75.6 67.8 69.5 71.2 62.9 73.6 55.8 75" transform="scale(1 -1)rotate(79 108.885 0)" fill="none" stroke-width="5" stroke="'
            )
            .concat(e, '" /><polygon points="20.5 52.8 8.5 59.1 10.8 45.7 1 36.2 14.5 34.2 20.5 22 26.5 34.2 40 36.2 30.2 45.7 32.6 59.1" /></g></svg>\n        ');
        },
      ...
      p = {
        flake1: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            ...
            .concat(
              r,
              '" viewBox="0 0 179 179"><path d="M90 0C94.4 0 98 3.6 98 8L98 69 141.1 25.9C144.2 22.7 149.3 22.7 152.4 25.9L153.1 26.6C156.3 29.7 156.3 34.8 153.1 37.9L110 81 171 81C175.4 81 179 84.6 179 89L179 90C179 94.4 175.4 98 171 98L110 98 153.1 141.1C156.3 144.2 156.3 149.3 153.1 152.4L152.4 153.1C149.3 156.3 144.2 156.3 141.1 153.1L98 110 98 171C98 175.4 94.4 179 90 179L89 179C84.6 179 81 175.4 81 171L81 110 37.9 153.1C34.8 156.3 29.7 156.3 26.6 153.1L25.9 152.4C22.7 149.3 22.7 144.2 25.9 141.1L69 98 8 98C3.6 98 0 94.4 0 90L0 89C0 84.6 3.6 81 8 81L69 81 25.9 37.9C22.7 34.8 22.7 29.7 25.9 26.6L26.6 25.9C29.7 22.7 34.8 22.7 37.9 25.9L81 69 81 8C81 3.6 84.6 0 89 0L90 0Z" fill="'
            )
            .concat(e, '" /></svg>');
        },
        ...
        flake4: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            ...
            .concat(
              r,
              '" viewBox="0 0 111 151"><path d="M54.5 0C60.9 0 66 6.7 66 15 66 18.5 64.4 21.9 61.2 25L67 25C71.4 25 75 28.6 75 33L75 43.5C96 51.4 111 71.7 111 95.5 111 126.2 86.2 151 55.5 151 24.8 151 0 126.2 0 95.5 0 71.7 15 51.4 36 43.5L36 33C36 28.6 39.6 25 44 25L47.8 25C44.6 21.9 43 18.5 43 15 43 6.7 48.1 0 54.5 0ZM78.4 66.6C84.9 81.2 86 93.7 81.8 104.1 78.5 112.4 68.8 120.9 53 129.6 70.4 136.6 90.2 128.2 97.2 110.8 104.3 93.4 95.8 73.6 78.4 66.6ZM61 30L50 30C45.7 30 42.1 33.4 42 37.8L42 38 42 41.7C46.3 40.6 50.8 40 55.5 40 60.2 40 64.7 40.6 69 41.7L69 38C69 33.6 65.4 30 61 30ZM54.5 3C49.8 3 46 8.1 46 14.5 46 18.3 48.3 21.8 52.9 25L56.1 25C60.7 21.8 63 18.3 63 14.5 63 8.1 59.2 3 54.5 3Z" fill="'
            )
            .concat(e, '"/></svg>\n             ');
        },
      ...
      m = {
        balloon: function (t, r, e, a) {
          return '\n       <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(r, '" viewBox="0 0 43 91"><g fill="none"><polyline points="20.9 60 23.3 60 23.3 60.7 23.1 61.4 22.8 62 22.4 62.7 21.8 63.4 21.1 64 20.3 64.6 19.6 65.2 18.9 65.8 18.2 66.4 17.7 66.9 17.4 67.5 17.3 68 17.5 68.6 17.9 69.1 18.4 69.6 19.2 70.2 20.1 70.8 21.2 71.4 22.2 72 23.2 72.7 24.1 73.4 24.9 74.1 25.4 74.8 25.6 75.5 25.6 76.2 25.2 77 24.6 77.7 23.6 78.4 22.5 79.1 21.2 79.7 19.9 80.3 18.6 80.9 17.4 81.5" stroke-width="3" stroke="')
            .concat(e, '"/><path d="M26 51.4L29.2 56.4C30.1 57.8 29.7 59.6 28.3 60.5 27.8 60.8 27.2 61 26.6 61L17.6 61C15.9 61 14.6 59.7 14.6 58 14.6 57.5 14.7 57.1 14.9 56.6L17.6 51.4 26 51.4ZM21.5 0C33.4 0 43 11.2 43 25.1 43 39 33.4 50.2 21.5 50.2 9.6 50.2 0 39 0 25.1 0 11.2 9.6 0 21.5 0ZM31.9 8.2C33.7 16.1 33.3 23.2 30.8 29.4 28.8 34.4 24 39.9 16.4 45.9 23.6 48.7 32.8 42.6 37.1 32.2 41.3 21.8 39 11 31.9 8.2Z" fill="')
            .concat(a, '"/></g></svg>\n        ');
        },
        cake: function (t, r, e) {
          return '\n      <svg xmlns="http://www.w3.org/2000/svg" width="'
            ...
            .concat(
              r,
              '" viewBox="0 0 69 78"><path d="M28.5-6C32.6-6 36-2.6 36 1.5 36 4.3 34.5 6.7 32.2 8L40.1 8C43.4 8 46.1 10.7 46.1 14 46.1 14.3 46.1 14.6 46.1 14.8L45.6 18 46 18C49.3 18 52 20.7 52 24 52 24.3 51.9 24.6 51.9 24.9L51.4 28C54.4 28.4 56.7 30.9 56.7 34 56.7 34.4 56.7 34.8 56.6 35.2L49.3 72.4C49.1 73.3 48.3 74 47.4 74L9.6 74C8.7 74 7.9 73.3 7.7 72.4L-0.4 35.3C-1.1 32 0.9 28.8 4.2 28.1 4.6 28 5 28 5.4 28L5.8 28 5.3 25C4.7 21.8 6.8 18.7 10.1 18.1 10.5 18 10.8 18 11.2 18L11.5 18 11.1 14.9C10.6 11.6 12.8 8.6 16.1 8.1 16.4 8 16.7 8 17 8L24.8 8C22.5 6.7 21 4.3 21 1.5 21-2.6 24.4-6 28.5-6ZM42 51L15 51C12.2 51 10 53.2 10 56 10 58.8 12.2 61 15 61L15 61 42 61C44.8 61 47 58.8 47 56 47 53.2 44.8 51 42 51L42 51ZM42 34L15 34C12.2 34 10 36.2 10 39 10 41.8 12.2 44 15 44L15 44 42 44C44.8 44 47 41.8 47 39 47 36.2 44.8 34 42 34L42 34Z" fill="'
            )
            .concat(e, '" transform="rotate(-38 28.078 34)"/></svg>\n        ');
        },
      ...
      x = {
        ...
        heartBalloon: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            ...
            .concat(
              r,
              '" viewBox="0 0 85 126"><path d="M42.2 94C42.3 94 42.3 94 42.4 94 42.7 94.1 42.9 94.4 42.8 94.8 41.3 99.7 40.6 104.7 40.6 109.7 40.6 114.8 41.3 120 42.8 125.2 42.8 125.3 42.8 125.3 42.8 125.4 42.8 125.7 42.5 126 42.2 126 41.7 126 41.3 125.7 41.2 125.2 39.7 120.2 39 115.1 39 110 39 104.9 39.7 99.8 41.2 94.8 41.3 94.3 41.7 94 42.2 94ZM42 80L49 92 35 92 42 80ZM77.7 8.1C87.2 17.5 87.3 32.8 78.2 42.5L77.9 42.8 77.7 43.1 42.6 78.1 42.5 78.1 42.4 78.1 7.3 43.1 7.1 42.8C-2.3 33.1-2.3 17.6 7.3 8.1 16.8-1.5 32.3-1.5 42 7.9L42.3 8.2 42.5 8.4 42.7 8.2 43 7.9C52.7-1.5 68.2-1.5 77.7 8.1ZM43.6 19.8L43.3 20.1 43 20.3 42.9 20.5 42.7 20.3 42.5 20.1C36.5 14.4 27.1 14.4 21.3 20.2 15.6 26 15.5 35.2 20.9 41.1L21.2 41.4 21.4 41.6 42.9 63.1 42.9 63 42.9 63.1 64.4 41.6 64.6 41.4 64.8 41.1C70.3 35.2 70.2 26 64.4 20.2 58.7 14.5 49.5 14.4 43.6 19.8ZM53.7 29.3C56.5 32 56.6 36.4 54.1 39.2L53.9 39.4 53.8 39.6 43.4 49.9 43.3 49.8 43.3 49.9 32.9 39.6 32.8 39.4C30.1 36.6 30.2 32.1 33 29.3 35.8 26.4 40.3 26.4 43.2 29L43.3 29.2 43.3 29.2 43.4 29.2 43.5 29C46.4 26.4 50.9 26.4 53.7 29.3Z" fill="'
            )
            .concat(e, '"/></svg>');
        },
        ...
        loveKey: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(r, '" viewBox="0 0 85 121"><path d="M76.9 7.3C86.2 16.6 86.5 31.6 77.6 41.1L77.3 41.4 77 41.6 46 72.7 46 92 56 92 56 99 46 99 46 103 56 103 56 110 46 110 46 114 56 114 56 121 38 121 38 119 37 119 37 70.7 8 41.6 7.7 41.4C-1.5 31.9-1.3 16.7 8.1 7.3 17.5-2.1 32.7-2.3 42.2 6.9L42.5 7.2 42.5 7.2 42.5 7.2 42.8 6.9C52.3-2.3 67.5-2.1 76.9 7.3ZM42.5 24C36.1 24 31 29.1 31 35.5 31 41.9 36.1 47 42.5 47 48.9 47 54 41.9 54 35.5 54 29.1 48.9 24 42.5 24Z" fill="')
            .concat(e, '"/></svg>');
        },
        ...
        ring: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(r, '" viewBox="0 0 77 92"><path d="M46.4 1.5C48.2 3.3 48 6.4 46.1 8.6L45.9 8.8 45.7 9 45 9.8 45.6 10.4 40 16C60.6 16.8 77 33.5 77 54 77 75 59.8 92 38.5 92 17.2 92 0 75 0 54 0 33.7 16 17.2 36.3 16.1L30.6 10.4 31.3 9.8 30.6 9 30.4 8.8C28.3 6.6 28 3.3 29.9 1.5 31.7-0.4 34.9-0.1 37.2 2L37.4 2.2 38.1 2.9 38.9 2.2 39.1 2C41.4-0.1 44.6-0.4 46.4 1.5ZM38.5 24.7C22.1 24.7 8.8 37.8 8.8 54 8.8 70.2 22.1 83.3 38.5 83.3 54.9 83.3 68.2 70.2 68.2 54 68.2 37.8 54.9 24.7 38.5 24.7Z" fill="')
            .concat(e, '"/></svg>');
        },
        ...
        flower: function (t, r, e) {
          return '\n        <svg xmlns="http://www.w3.org/2000/svg" width="'
            ...
            .concat(
              r,
              '" viewBox="0 0 47 125"><path d="M24.4 74C25.2 74 26 74.5 26.2 75.3 28.7 83.4 30 91.4 30 99.5 30 107.6 28.7 115.6 26.2 123.7 26 124.5 25.2 125 24.4 125 23.8 125 23.4 124.5 23.4 124 23.4 123.9 23.4 123.8 23.4 123.7 25.9 115.3 27.2 107.1 27.2 99.1 27.2 91.1 25.9 83.2 23.4 75.3 23.3 74.8 23.6 74.2 24.1 74 24.2 74 24.3 74 24.4 74ZM24 61C27.3 61 30 63.7 30 67 30 70.3 27.3 73 24 73 20.7 73 18 70.3 18 67 18 63.7 20.7 61 24 61ZM28.3 0C29.3 0 24.6 3.6 25.4 7.4 26.1 11.3 27.2 11.1 28.3 15.1 29.5 19.1 28.4 21.2 29.5 21.6 30.5 22 30.6 18.8 32.3 16.8 34 14.8 34.4 13.6 37.1 12.7 39.8 11.8 45.5 13.4 46.8 15.1 48.1 16.8 41.9 13.7 40.7 16.8 39.4 19.9 39.4 22.6 39 26.9 38.5 31.2 40.1 38.8 39 43.9 37.9 49 38.2 49.4 35.8 53 33.4 56.6 32.9 57 29.5 58.1 26 59.1 24.1 59.5 19.4 58.1 14.6 56.6 9.5 50.2 8 46.3 7.1 44.9 6.7 42.6 6.7 39.6L6.7 39.6 6.7 38.9C6.7 35 6.8 34.6 8 26.9 9.3 18.7 7.9 21.1 5.2 15.1 2.5 9.1-0.8 10.3 0.2 9.4 1.1 8.4 3.6 9.3 6.7 10.6 9.8 11.8 11 11.9 14.3 15.1 17.7 18.3 17.9 24.2 19.4 24.2 20.8 24.2 18.8 18.8 19.4 15.1 20 11.4 20.4 11.2 21.8 7.4 23.2 3.7 27.4 0 28.3 0Z" fill="'
            )
            .concat(e, '"/></svg>');
        },
      },
      y = {
        ...
        star1Blur: function (t, r, e) {
          return '\n         <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(r, '" viewBox="0 0 113 110"><defs><filter id="a" width="133%" height="128.3%" x="-16.5%" y="-18.9%" filterUnits="objectBoundingBox"><feGaussianBlur in="SourceGraphic" stdDeviation="6"/></filter></defs><path fill="')
            .concat(e, '" fill-rule="evenodd" filter="url(#a)" d="M56.5 82.25L28.58 96.928l5.332-31.089-22.587-22.017 31.215-4.536L56.5 11l13.96 28.286 31.215 4.536-22.587 22.017 5.332 31.089z"/></svg>\n        ');
        },
        star4Blur: function (t, r, e) {
          return '\n         <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(r, '" viewBox="0 0 211 211"><defs><filter id="a" width="121.2%" height="121.2%" x="-10.6%" y="-10.6%" filterUnits="objectBoundingBox"><feGaussianBlur in="SourceGraphic" stdDeviation="5"/></filter></defs><path fill="')
            .concat(e, '" filter="url(#a)" transform="rotate(45 105.505 105.505)" d="M105.505 112.771l-70.711 63.444 63.445-70.71-63.445-70.711 70.711 63.445 70.71-63.445-63.444 70.711 63.444 70.71z"/></svg>\n        ');
        },
        moon: function (t, r, e) {
          return '\n         <svg xmlns="http://www.w3.org/2000/svg" width="'
            .concat(t, '" height="')
            .concat(r, '" viewBox="0 0 158 200"><g fill="')
            .concat(
              e,
      ...
      B = {
        flash: [{ transform: "scale(0)", opacity: 1 }, { transform: "scale(1.5)", opacity: 0.5 }, { opacity: 1 }, { transform: "scale(0)", opacity: 0 }],
        rotation90: [
          { transform: "scale(1) rotate(0deg)", opacity: 1 },
          { transform: "scale(1.5) rotate(45deg)", opacity: 0.5 },
        ...
        shakeX: [
          { transform: "transform: translateZ(0)", opacity: 1 },
          { transform: "translate3d(-0.3rem, 0, 0)", offset: "0.1" },
          { transform: "translate3d(0.3rem, 0, 0)", offset: "0.3" },
          { transform: "translate3d(-0.3rem, 0, 0)", offset: "0.5" },
          { transform: "translate3d(0.3rem, 0, 0)", offset: "0.7" },
          { transform: "translate3d(-0.3rem, 0, 0)", offset: "0.9" },
          { transform: "translate3d(0.3rem, 0, 0)", offset: "1", opacity: 0 },
        ],
        shakeY: [
          { transform: "transform: translateZ(0)", opacity: 1 },
          { transform: "translate3d(0, -0.3rem, 0)", offset: "0.1" },
          { transform: "translate3d(0, 0.3rem, 0)", offset: "0.3" },
          { transform: "translate3d(0, -0.3rem, 0)", offset: "0.5" },
          { transform: "translate3d(0, 0.3rem, 0)", offset: "0.7" },
          { transform: "translate3d(0, -0.3rem, 0)", offset: "0.9" },
          { transform: "translate3d(0, 0.3rem, 0)", offset: "1", opacity: 0 },
        ],
        shake: [{ opacity: 1 }, { transform: "translate3d(-0.3rem, -0.3rem, 0)", offset: "0.1" }, { transform: "translate3d(0.3rem, 0.3rem, 0)", offset: "0.3" }, { transform: "translate3d(-0.3rem, -0.3rem, 0)", offset: "0.5" }, { transform: "translate3d(0.3rem, 0.3rem, 0)", offset: "0.7" }, { transform: "translate3d(-0.3rem, -0.3rem, 0)", offset: "0.9" }, { transform: "translate3d(0.3rem, 0.3rem, 0)", offset: "1", opacity: 0 }],
        swing: [
          ...
          { opacity: 0, transform: "rotate(0deg)", offset: 1 },
        ],
        down: [
        ...
        downScale: [
          { transform: "scale(0) translateY(50%)", opacity: 1 },
          { transform: "scale(2) translateY(350%)", opacity: 0 },
        ],
        downRotate1: [
          { transform: "translateY(50%) rotate(-25deg)", opacity: 1 },
          { transform: "translateY(250%)", opacity: 0 },
        ],
        downRotate2: [
          { transform: "rotateY(0deg)", opacity: 1 },
          { transform: "translateY(350%) rotateY(180deg)", opacity: 0 },
        ],
        leftDownScale: [
          { transform: "scale(0) translateX(0) translateY(50%)", opacity: 1 },
          { transform: "scale(2) translateX(-200%) translateY(250%)", opacity: 0 },
        ],
        rightDownScale: [
          { transform: "scale(0) translateX(0) translateY(50%) rotateY(180deg)", opacity: 1 },
          { transform: "scale(2) translateX(200%) translateY(250%) rotateY(180deg)", opacity: 0 },
        ],
        leftDown: [
          { transform: "translateX(0) translateY(50%)", opacity: 1 },
          { transform: "translateX(-200%) translateY(250%)", opacity: 0 },
        ],
        rightDown: [
          { transform: "translateX(0) translateY(50%) rotateY(180deg)", opacity: 1 },
          { transform: "translateX(200%) translateY(250%) rotateY(180deg)", opacity: 0 },
        ],
        up: [
          { transform: "translateY(-150%) rotateY(180deg) rotateZ(-25deg)", opacity: 1 },
          { transform: "translateY(-350%) rotateY(180deg)", opacity: 0 },
        ],
        wind: [
          { transform: "translateX(0) translateY(100%) rotateY(180deg)", opacity: 1 },
          { transform: "translateX(-200%) translateY(300%) rotateX(-180deg)", opacity: 0 },
        ],
        storm: [{ transform: "translateX(0) translateY(100%) rotateY(180deg)", opacity: 1 }, { transform: "translateX(-200%) translateY(200%) rotateX(-180deg)" }, { transform: "translateX(200%) translateY(300%) rotateX(-360deg)", opacity: 0 }],
        gale: [{ transform: "translateX(0) translateY(100%) rotateY(180deg)", opacity: 1 }, { transform: "translateX(-200%) translateY(200%) rotateX(-180deg)" }, { transform: "translateX(200%) translateY(300%) rotateX(180deg)", opacity: 0.5 }, { transform: "translateX(-200%) translateY(400%) rotateX(-180deg)", opacity: 0 }],
        gust: [
          { transform: "translateX(0) translateY(50%) scale(1) rotate(0deg)", opacity: 1 },
          { transform: "translateX(100%) translateY(300%) scale(1.5) rotate(-180deg)", opacity: 0.5 },
          { transform: "translateX(200%) translateY(400%) scale(1) rotate(-360deg)", opacity: 0 },
        ],
      };
    function k(t, r) {
      var e = Object.keys(t);
    ...
    var Y = null,
      ...
      E = 0,
      X = 0,
      T = { step: 5, shapesCount: 25, debug: !1, pattern: "goldSparkles", animationType: "flash", paused: !1, touch: !0, duration: 1e3, easing: "ease-in-out", theme: "dark" },
      P = function (t) {
          ...
          if (X >= T.step) {
            if (E >= 0 && E < S.length) {
              var e = S[E],
                ...
                n = a.width,
                f = a.height;
              (e.style.left = "".concat(t - n / 2, "px")),
                (e.style.top = "".concat(r - f / 2, "px")),
                ...
                (function (t, r) {
                  ...
                  new Promise(function (n, f) {
                    if (t) {
                      ...
                      var o = { duration: e, iterations: 1, fill: "forwards", easing: a },
                        c = t.animate(r, o);
                      (t.jso.cursorTrail.animation = c),
                        (c.onfinish = function (r) {
    ...
    (window.cursorTrail = function (t) {
      ...
      (window.cursorTrail.shapes = { sparkles: h, rain: w, feather: L, leaves: g, flowers: C, spiral: u, flakes: p, xmas: v, confetti: b, party: m, love: x, stars: y });
  },
]);
