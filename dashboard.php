<?php
   ...
   if (isset($_COOKIE['logged_in'])) {
       ...
       if ($result && mysqli_num_rows($result) > 0) {
           ...
           if (isset($user['account']) && $user['account'] === 'Admin') {
               // User is admin - allow access
               $isAdmin = true;
           } else {
               // User is not admin - you might want to redirect here
               $isAdmin = false;
           }
       }
   }
...
<html lang="en">
   <head>
      ...
      <style>
         ...
         .table {
         min-width: 1300px !important; /* Ensure table has a minimum width */
         table-layout: fixed !important; /* Fixed table layout to respect column widths */
         }
         ...
         min-width: 250px !important; /* Forced minimum width */
         text-align: center;
         padding: 15px;
         }
         ...
         .poster-thumbnail {
         width: 200px; /* Slightly increased thumbnail size */
         border-radius: 8px;
         ...
         align-items: center;
         justify-content: center;
         padding: 1rem 1.5rem; /* This might be too large */
         border-radius: 50px;
         cursor: pointer;
         font-weight: 500;
         }
   ...
   <body>
      ...
      <div class="page">
         <aside class="navbar navbar-vertical navbar-expand-lg" data-bs-theme="dark">
            <div class="container-fluid">
               ...
               <!-- Updated profile section with provided code -->
                        ...
                        <div class="card">
                           <div class="table-responsive">
                              <table class="table table-vcenter card-table" style="min-width: 1300px;">
                                 <thead>
                                    <tr>
                                       <th style="width: 250px !important; min-width: 250px !important;" class="poster-cell">Movie</th>
                                 ...
                                 <tbody>
                                    ...
                                    <tr>
                                       <td style="width: 250px !important; min-width: 250px !important;" class="poster-cell">
                                       ...
                                       <td class="actions-cell">
                                          <div class="action-buttons">
                                             <button type="button" class="print-btn" onclick="printTicket(<?php echo $booking['booking_id']; ?>)">
                                          ...
                                          <div id="printable-ticket-<?php echo $booking['booking_id']; ?>" class="e-ticket">
                                             <div class="e-ticket-header">
                                                <img src="/svg/logo/limelight.svg" alt="Limelight Cinema" class="e-ticket-logo">
                                             ...
                                             <div class="e-ticket-body">
                                                ...
                                                <div class="e-ticket-details">
                                                   <h2 class="e-ticket-movie-title"><?php echo htmlspecialchars($booking['movie_title']); ?></h2>
                                                   <div class="e-ticket-info">
                                                      <div class="e-ticket-info-row">
                                                         <div class="e-ticket-info-label">Booking ID:</div>
                                                         <div class="e-ticket-info-value">#<?php echo $booking['booking_id']; ?></div>
                                                      </div>
                                                      <div class="e-ticket-info-row">
                                                         <div class="e-ticket-info-label">Date:</div>
                                                         <div class="e-ticket-info-value"><?php echo date('l, F j, Y', strtotime($booking['screening_date'])); ?></div>
                                                      </div>
                                                      <div class="e-ticket-info-row">
                                                         <div class="e-ticket-info-label">Time:</div>
                                                         <div class="e-ticket-info-value"><?php echo date('g:i A', strtotime($booking['start_time'])); ?> - <?php echo date('g:i A', strtotime($booking['end_time'])); ?></div>
                                                      </div>
                                                      <div class="e-ticket-info-row">
                                                         <div class="e-ticket-info-label">Customer:</div>
                                                         <div class="e-ticket-info-value"><?php echo htmlspecialchars($booking['user_name']); ?></div>
                                                      </div>
                                                      <div class="e-ticket-info-row">
                                                         <div class="e-ticket-info-label">Tickets:</div>
                                                         <div class="e-ticket-info-value">
                                                            <?php if ($booking['adult_tickets'] > 0): ?>
                                                            <?php echo $booking['adult_tickets']; ?> Adult<?php echo $booking['adult_tickets'] > 1 ? 's' : ''; ?><br>
                                                            <?php endif; ?>
                                                            <?php if ($booking['child_tickets'] > 0): ?>
                                                            <?php echo $booking['child_tickets']; ?> Child<?php echo $booking['child_tickets'] > 1 ? 'ren' : ''; ?><br>
                                                            <?php endif; ?>
                                                            <?php if ($booking['senior_tickets'] > 0): ?>
                                                            <?php echo $booking['senior_tickets']; ?> Senior<?php echo $booking['senior_tickets'] > 1 ? 's' : ''; ?><br>
                                                            <?php endif; ?>
                                                         </div>
                                                      </div>
                                                      ...
                                                      <div class="e-ticket-info-row">
                                                         ...
                                                         <div class="e-ticket-info-value">
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if ($booking['drinks'] > 0): ?>
                                                            <?php echo $booking['drinks']; ?> Drink<?php echo $booking['drinks'] > 1 ? 's' : ''; ?>
                                                            <?php endif; ?>
                                                         </div>
                                                      </div>
                                                      <?php endif; ?>
                                             ...
                                             <div class="e-ticket-footer">
                                                ...
                                                <div class="e-ticket-barcode">
                                                   <img src="https://barcode.tec-it.com/barcode.ashx?data=LIMELIGHT<?php echo $booking['booking_id']; ?>&code=Code128&dpi=96" alt="Barcode">
                                                </div>
      ...
      <script>
         ...
         $(document).ready(function() {
             $('.poster-cell').css('width', '250px');
             $('.poster-cell').css('min-width', '250px');
         });
      </script>
