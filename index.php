            ...
            <div class="swiper-wrapper">
                ...
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)): ?>
                    <div class="swiper-slide" style="background-image: url('<?php echo htmlspecialchars($row['poster_url']); ?>'); background-size: cover; background-position: center center">
                        <a href="booking.php?id=<?php echo htmlspecialchars($row['id']); ?>&title=<?php echo urlencode($row['title']); ?>">
                        <button class="btn">
...
<section class="content-trending">
    <div class="padding" style="padding-top: 0 !important;">
        ...
        <div class="swiper ComingSoon">
            <div class="swiper-wrapper">
                <?php
                $result = mysqli_query($dbhandle, "SELECT * FROM movies_soon");
                while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)): ?>
                    <div class="swiper-slide" style="background-image: url('<?php echo htmlspecialchars($row['movie_banner_url']); ?>'); background-size: cover; background-position: center center">
                        <h1 class="title"><? echo htmlspecialchars($row['title']); ?></h1>
                    </div>
                <?php endwhile; ?>
            </div>
            <div class="swiper-scrollbar"></div>
        ...
        <div class="swiper yoo">
            <div class="swiper-wrapper">
                <div class="swiper-slide testing">
                    <div class="icon-text">
                        <img src="theater.svg" id="horror" alt="comedy" />
                        <h1 class="category-h1">Comedy</h1>
                    </div>
                </div>
                <div class="swiper-slide testing">
                    <div class="icon-text">
                        <img src="spider-web.svg" id="horror" alt="comedy" />
                        <h1 class="category-h1">Horror</h1>
                    </div>
                </div>
                <div class="swiper-slide testing">
                    <div class="icon-text">
                        <img src="heart.svg" id="horror" alt="comedy" />
                        <h1 class="category-h1">Romantic</h1>
                    </div>
                </div>
                <div class="swiper-slide testing">
                    <div class="icon-text">
                        <img src="music.svg" id="horror" alt="comedy" />
                        <h1 class="category-h1">Musical</h1>
                    </div>
                </div>
                <div class="swiper-slide testing">
                    <div class="icon-text">
                        <img src="face-alien.svg" id="horror" alt="comedy" />
                        <h1 class="category-h1">Sci-Fi</h1>
                    </div>
                </div>
                <div class="swiper-slide testing">
                    <div class="icon-text">
                        <img src="compass.svg" id="horror" alt="comedy" />
                        <h1 class="category-h1">Adventure</h1>
                    </div>
                </div>
                <div class="swiper-slide testing">
                    <div class="icon-text">
                        <img src="swords.svg" id="horror" alt="comedy" />
...
<script>
    var options = {placeholder: 'Sort by'};
    NiceSelect.bind(document.getElementById("a-select"), options);
    ...
    $(document).ready(function () {
        $('#a-select').change(function () {
            ...
            if (sortCriterion) {
                $.ajax({
                    url: "order.php", // The PHP script that returns the new swiper slides
...
<script>
    var swiper = new Swiper(".ComingSoon", {
        slidesPerView: 4,
    spaceBetween: 15,
    grabCursor: true,
    breakpoints: {
